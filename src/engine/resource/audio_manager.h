...
namespace engine::resource
{
    ...
    private:
        ...
        std::unordered_map<std::string, std::unique_ptr<MIX_Audio, SDLAudioDeleter>> audios_;
        std::unordered_map<std::string, std::unique_ptr<MIX_Audio, SDLAudioDeleter>> musics_;
